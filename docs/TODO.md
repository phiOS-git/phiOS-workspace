...
2. the settings panel now can be laggy especially with live previews. Make them toggable and hidden by default (should be toggled on when their relative option like ambient effect change)
