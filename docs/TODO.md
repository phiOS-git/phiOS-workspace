...
- [taken] The notification button in the status bar toggles the panel but does not set the tab to notifications. Also clipboard and notification panels should get the active state coherently to the active tab.
