...
- the runner should resize it’s height when there are not enough options to fill it. (Anchored on the top)
...
- clipboard should reset the current selection every time it’s opened, starting back from the top.
